...
| **6** | 02/05/2026 | [Lecture 6 Slides (Pauses)](https://farouky.github.io/files/CS498_Lecture_6_Final.pdf) | — | *formulation strength and cover inequalities, Binary modeling patterns, fixed-charge and logical constraints, Big-M (tight vs loose), SOS1/SOS2.* | Review binary variable modeling in Gurobi. |  |  |
