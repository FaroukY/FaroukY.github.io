...
|---|---|---|---|---|---|---|---|
| **1** | 01/20/2026 | [Lecture 1 Slides (Pauses)](https://farouky.github.io/files/CS498_Lecture_1_PausesV1.pdf) | [Lecture 1 Handout](https://farouky.github.io/files/CS498_Lecture_1_HandoutV1.pdf) | *Course overview, comparison to CS374/473, tooling stack, history of LP, Engineer’s Diet problem, Gurobi output interpretation.* | Read syllabus; [install Gurobi](https://www.gurobi.com/features/academic-named-user-license/) + Python env. | Review LP basics; try "Engineer’s Diet" Problem in HW1 | [Homework 1 Released](https://farouky.github.io/files/CS498_Homework1_Final.pdf) and the [Jupyter Notebook](https://farouky.github.io/files/CS498_Homework1_Final.ipynb.zip). Due Feb 01/2026 midnight 11:59 p.m. |
| **2** | 01/22/2026 | [Lecture 2 Slides (Pauses)](https://farouky.github.io/files/CS498_Lecture_2_PausesV1.pdf) | [Lecture 2 Handout](https://farouky.github.io/files/CS498_Lecture_2_HandoutV1.pdf) | *Simplex algorithm, geometric intuition, basic feasible solutions, pivoting, LP duality, accessing duals in Gurobi.* | Refresh your memory with Matplotlib/pandas. | Finish HW 1. |  |

<!--
| **3** | 01/27/2026 | [Lecture 3 Slides (Pauses)](https://farouky.github.io/files/CS498_Lecture_3_PausesV1.pdf) | [Lecture 3 Handout](https://farouky.github.io/files/CS498_Lecture_3_HandoutV1.pdf) | *Sensitivity analysis, shadow prices, complementary slackness, discussed duals as “what-if” tools for constraints, network flow models, interpreting Gurobi duals, and shadow price limitations.* |  |  |  |
| **4** | 01/29/2026 | [Lecture 4 Slides (Pauses)](https://farouky.github.io/files/CS498_Lecture_4_PausesV1.pdf) | [Lecture 4 Handout](https://farouky.github.io/files/CS498_Lecture_4_HandoutV1.pdf) | *LP relaxations, vertex cover modeling, LP rounding (0.5-threshold), assignment problem (total unimodularity), independent set and integrality gaps.* | Review graph basics and Gurobi modeling syntax. |  | Homework 2 Released. Due TBD midnight 11:59 p.m. |
| **5** | 02/03/2026 | Lecture 5 Slides (Pauses) | — | *Integer programs vs LP relaxations, 0–1 knapsack, LP bounds, branch-and-bound (bounds, incumbents, pruning), formulation strength and cover inequalities.* | Review LP relaxations from Lecture 4. |  |  |
| **6** | 02/05/2026 | Lecture 6 Slides (Pauses) | — | *Binary modeling patterns, fixed-charge and logical constraints, Big-M (tight vs loose), SOS1/SOS2, TSP modeling and subtour elimination.* | Review binary variable modeling in Gurobi. |  |  |
-->
